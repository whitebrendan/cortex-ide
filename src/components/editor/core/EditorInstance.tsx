    ...
    if (fileId !== currentFileId || filePath !== currentFilePath) {
      ...
      const baseOptions: Monaco.editor.IStandaloneEditorConstructionOptions = {
        ...
        minimap: {
          ...
          autohide: "mouseover",
          side: settingsState.settings.editor.minimapSide ?? "right",
          showSlider: settingsState.settings.editor.minimapShowSlider ?? "mouseover",
          renderCharacters: settingsState.settings.editor.minimapRenderCharacters ?? false,
          maxColumn: settingsState.settings.editor.minimapWidth ?? 80,
          scale: settingsState.settings.editor.minimapScale ?? 1,
          size: "proportional",
        },
