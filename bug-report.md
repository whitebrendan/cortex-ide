...
This document reconciles two worker branch reports into a single file.

- Source branch `worker/7fe68ab9-ac3/1772520097916`: DOM & visual smoke test report
- Source branch `worker/d46ddcf2-c38/1772520097600`: IPC command bug report
