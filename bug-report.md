# Cortex IDE — Reconciled Worker Bug Reports

**Reconciled from:**
- `worker/7fe68ab9-ac3/1772520097916` (commit `6e975da07c0722be0731dab5a90e22e15cabf45e`)
- `worker/d46ddcf2-c38/1772520097600` (commit `fdbd2b762378a00d501071022384eac51d3224fc`)

> Note: Both worker branches introduced `bug-report.md` with different content. This reconciled document preserves both reports in full.

---

## Report 1 — DOM & Visual Smoke Test
