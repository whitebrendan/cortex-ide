# Cortex IDE — Consolidated Bug Reports

This document reconciles the two worker-branch reports into a single file.

- Source 1: `worker/7fe68ab9-ac3/1772520097916` (`docs(qa): add DOM & visual smoke test bug report`)
- Source 2: `worker/d46ddcf2-c38/1772520097600` (`docs: add comprehensive IPC command bug report`)

---

## Report 1 — DOM & Visual Smoke Test Bug Report
...
## Report 2 — IPC Command Bug Report
